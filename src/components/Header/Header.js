  ...
  return (
    <header className="header">
      ...
      <div className="header__container header__container_visible">
        ...
        <NavLink to="/"><img src={contact} className="button header__logo" alt="Контакты" /></NavLink>
      </div>
      <nav className="header__container header__container_visible">
        ...
        <div className="header__container">
          <NavLink to="/" className="button header__button"><img className="header__nav" src={insta} alt="Инстаграм" /></NavLink>
          <NavLink to="/" className="button header__button"><img className="header__nav" src={telegram} alt="Телеграм" /></NavLink>
          <NavLink to="/" className="button header__button"><img className="header__nav" src={watsapp} alt="Вотсапп" /></NavLink>
          <NavLink to="/" className="button header__button"><img className="header__nav" src={account} alt="Личный кабинет" /></NavLink>
          <NavLink to="/" className="button header__button"><img className="header__nav" src={basket} alt="Корзина" /></NavLink>
      ...
      <nav className="header__container header__container_rose header__container_hidden">
        <div className="header__container header__container_top">
          <NavLink to="/" className="button header__button header__button_top">КАТАЛОГ</NavLink>
          <NavLink to="/" className="button header__button header__button_top">НОВИНКИ</NavLink>
          <NavLink to="/" className="button header__button header__button_top">PREMIUM ТОВАРЫ</NavLink>
          <NavLink to="/" className="button header__button header__button_top">СКИДКИ</NavLink>
          <NavLink to="/" className="button header__button header__button_top">ПОДАРОЧНЫЙ СЕРТИФИКАТ</NavLink>
        </div>
        <div className="header__container header__container_bottom">
          <NavLink to="/" className="button header__button">РАЗДЕЛЬНЫЕ КУПАЛЬНИКИ</NavLink>
          <NavLink to="/" className="button header__button">СЛИТНЫЕ КУПАЛЬНИКИ</NavLink>
          <NavLink to="/" className="button header__button">ТУНИКИ</NavLink>
          <NavLink to="/" className="button header__button">ШЛЯПЫ</NavLink>
          <NavLink to="/" className="button header__button">ОЧКИ</NavLink>
        </div>
      </nav>
    </header>
  );
